...
createPortfolioItem = (data) => {
  ...
  portfolioItem.className =
    "h-[18rem] w-full bg-[url('" +
    data.image +
    "')] bg-cover cursor-pointer rounded-xl relative";

  const overlay = document.createElement("div");
  overlay.className =
    "absolute top-0 left-0 w-full h-full bg-gray-700 opacity-0 transition-opacity duration-300 rounded-xl";
  ...
  description.className = "text-sm mt-2 text-white";
